...
Pod::Spec.new do |s|
  ...
  s.homepage     = "https://github.com/xianrenzhuimeng/WMBase"
  ...
  s.source       = { :git => "https://github.com/xianrenzhuimeng/WMBase.git", :tag => s.version.to_s }
  ...
  s.source_files  = "WMBase/WMBase/**/*.{h,m}"
